"""
Django settings for qostream_42497 project.
...
ROOT_URLCONF = 'qostream_42497.urls'
...
WSGI_APPLICATION = 'qostream_42497.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "qostream_42497 API",
    "DESCRIPTION": "API documentation for qostream_42497 App",
    "VERSION": "v1",
}
